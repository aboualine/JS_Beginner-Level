...
document.getElementById("btnAdd").addEventListener("click" , (event) => {
    ...
    if (inputContent === "") {
        ...
        document.getElementById("delete").addEventListener("click" , (event) => {
            ...
            const taskToDelete = button.getAttribute("data-value");
            const taskIndex = table.indexOf(taskToDelete);
            if (taskIndex !== -1) {
                table.splice(taskIndex, 1);
                console.log("the task removed is : "+taskToDelete);
            }
